...
import Network.Basal.Protocols.Link.Ether (ethData, send, recvFrom)
import Network.Basal.Protocols.Link.Arp.Internal (lookupArpTable, ethPacket, ethPacket', arpSenderMac, socket, socket')

import Data.Int (Int64)
import Data.Maybe (maybe)
import Data.Tuple.Extra (first, second, dupe)
import Network.Info (MAC, NetworkInterface, IPv4 (..))
